...
for index in range(1, 5):
    ...
    try:
        ...
        sourceData = sourceFileData.read()[14:-2]
        targetFileData = codecs.open(FinalSavedInfoFile,'a','utf-8')
    ...
    try:
        ...
        targetFileData = codecs.open(FinalDownloadPdfFailLists,'a','utf-8')
        targetFileData.write(sourceData)
    except Exception, e:
